...
module attributes {transform.with_named_sequence} {
  ...
  func.func @attention(%arg0: tensor<1x4x1024x64xf16>, %arg1: tensor<1x4x1024x64xf16>, %arg2: tensor<1x4x1024x64xf16>) -> tensor<1x4x1024x64xf16> {
    ...
    %9 = stablehlo.add %8, %c : tensor<1024x1024xi64>
    ...
    %12 = stablehlo.select %11, %c_0, %c_1 : tensor<1024x1024xi1>, tensor<1024x1024xi1>
    %13 = stablehlo.reshape %12 : (tensor<1024x1024xi1>) -> tensor<1x1x1024x1024xi1>
    %14 = stablehlo.broadcast_in_dim %13, dims = [0, 1, 2, 3] : (tensor<1x1x1024x1024xi1>) -> tensor<1x4x1024x1024xi1>
    %15 = stablehlo.broadcast_in_dim %6, dims = [0, 1, 2, 3] : (tensor<1x4x1024x1024xf32>) -> tensor<1x4x1024x1024xf32>
    %16 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x4x1024x1024xf32>
    %17 = stablehlo.select %14, %15, %16 : tensor<1x4x1024x1024xi1>, tensor<1x4x1024x1024xf32>
    %18 = stablehlo.reduce(%17 init: %cst) applies stablehlo.maximum across dimensions = [3] : (tensor<1x4x1024x1024xf32>, tensor<f32>) -> tensor<1x4x1024xf32>
    %19 = stablehlo.reshape %18 : (tensor<1x4x1024xf32>) -> tensor<1x4x1024x1xf32>
    %20 = stablehlo.broadcast_in_dim %19, dims = [0, 1, 2, 3] : (tensor<1x4x1024x1xf32>) -> tensor<1x4x1024x1024xf32>
    %21 = stablehlo.subtract %17, %20 : tensor<1x4x1024x1024xf32>
    %22 = stablehlo.exponential %21 : tensor<1x4x1024x1024xf32>
    %23 = stablehlo.reduce(%22 init: %cst_2) applies stablehlo.add across dimensions = [3] : (tensor<1x4x1024x1024xf32>, tensor<f32>) -> tensor<1x4x1024xf32>
    %24 = stablehlo.reshape %23 : (tensor<1x4x1024xf32>) -> tensor<1x4x1024x1xf32>
    %25 = stablehlo.broadcast_in_dim %24, dims = [0, 1, 2, 3] : (tensor<1x4x1024x1xf32>) -> tensor<1x4x1024x1024xf32>
    %26 = stablehlo.divide %22, %25 : tensor<1x4x1024x1024xf32>
    %27 = stablehlo.convert %26 : (tensor<1x4x1024x1024xf32>) -> tensor<1x4x1024x1024xf16>
    %28 = stablehlo.broadcast_in_dim %arg2, dims = [0, 1, 2, 3] : (tensor<1x4x1024x64xf16>) -> tensor<1x4x1024x64xf16>
    %29 = stablehlo.dot_general %27, %28, batching_dims = [0, 1] x [0, 1], contracting_dims = [3] x [2] : (tensor<1x4x1024x1024xf16>, tensor<1x4x1024x64xf16>) -> tensor<1x4x1024x64xf32>
    %30 = stablehlo.convert %29 : (tensor<1x4x1024x64xf32>) -> tensor<1x4x1024x64xf16>
...
// CHECK: %[[LIVE:.+]]:5 = scf.for %{{.*}} = %c0 to %[[CAPPED_BOUND]] step %c1 iter_args(
// CHECK: scf.yield
