...
module attributes {transform.with_named_sequence} {
  ...
  transform.named_sequence @__transform_main(%module: !any) {
    ...
    %b_kscale = transform.get_consumers_of_result %forall_loop[0] : (!any) -> !any
    transform.linalg.greedy_inline_elementwise %b_kscale : !any
    transform.fusion.into_producer %b_kscale into %forall_loop : (!any, !any) -> !any
    ...
    %b_vscale = transform.get_consumers_of_result %forall_loop[0] : (!any) -> !any
    transform.fusion.into_producer %b_vscale into %forall_loop : (!any, !any) -> !any
    transform.apply_cse to %func : !any
    ...
    %trunc = transform.get_consumers_of_result %forall_loop[3] : (!any) -> !any
