...
module attributes {transform.with_named_sequence} {
  ...
  func.func @attention(%arg0: tensor<1x4x1x64xf16>, %arg1: tensor<1x4x1024x64xf16>, %arg2: tensor<1x4x1024x64xf16>) -> tensor<1x4x1x64xf16> {
    ...
    %0 = stablehlo.convert %arg0 : (tensor<1x4x1x64xf16>) -> tensor<1x4x1x64xf32>
    ...
    %4 = stablehlo.dot_general %0, %3, batching_dims = [0, 1] x [0, 1], contracting_dims = [3] x [2] : (tensor<1x4x1x64xf32>, tensor<1x4x64x1024xf32>) -> tensor<1x4x1x1024xf32>
    %5 = stablehlo.convert %cst_1 : (tensor<1xf64>) -> tensor<1xf32>
    %6 = stablehlo.reshape %5 : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x4x1x1024xf32>
    %8 = stablehlo.multiply %4, %7 : tensor<1x4x1x1024xf32>
    %9 = stablehlo.reduce(%8 init: %cst) applies stablehlo.maximum across dimensions = [3] : (tensor<1x4x1x1024xf32>, tensor<f32>) -> tensor<1x4x1xf32>
    %10 = stablehlo.reshape %9 : (tensor<1x4x1xf32>) -> tensor<1x4x1x1xf32>
    %11 = stablehlo.broadcast_in_dim %10, dims = [0, 1, 2, 3] : (tensor<1x4x1x1xf32>) -> tensor<1x4x1x1024xf32>
    %12 = stablehlo.subtract %8, %11 : tensor<1x4x1x1024xf32>
    %13 = stablehlo.exponential %12 : tensor<1x4x1x1024xf32>
    %14 = stablehlo.reduce(%13 init: %cst_0) applies stablehlo.add across dimensions = [3] : (tensor<1x4x1x1024xf32>, tensor<f32>) -> tensor<1x4x1xf32>
    %15 = stablehlo.reshape %14 : (tensor<1x4x1xf32>) -> tensor<1x4x1x1xf32>
    %16 = stablehlo.broadcast_in_dim %15, dims = [0, 1, 2, 3] : (tensor<1x4x1x1xf32>) -> tensor<1x4x1x1024xf32>
    %17 = stablehlo.divide %13, %16 : tensor<1x4x1x1024xf32>
    %18 = stablehlo.convert %arg2 : (tensor<1x4x1024x64xf16>) -> tensor<1x4x1024x64xf32>
    %19 = stablehlo.broadcast_in_dim %18, dims = [0, 1, 2, 3] : (tensor<1x4x1024x64xf32>) -> tensor<1x4x1024x64xf32>
    %20 = stablehlo.dot_general %17, %19, batching_dims = [0, 1] x [0, 1], contracting_dims = [3] x [2] : (tensor<1x4x1x1024xf32>, tensor<1x4x1024x64xf32>) -> tensor<1x4x1x64xf32>
    %21 = stablehlo.convert %20 : (tensor<1x4x1x64xf32>) -> tensor<1x4x1x64xf16>
    return %21 : tensor<1x4x1x64xf16>
  }
}
