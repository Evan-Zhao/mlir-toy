...
module attributes {transform.with_named_sequence} {
  ...
  func.func @attention(%arg0: tensor<1x4x1024x128xf16>, %arg1: tensor<1x1x1024x128xf16>, %arg2: tensor<1x1x1024x128xf16>) -> tensor<1x4x1024x128xf16> {
    ...
    %25 = stablehlo.reshape %24 : (tensor<1x4x1x1024x128xf16>) -> tensor<1x4x1024x128xf16>
    return %25 : tensor<1x4x1024x128xf16>
  }
}

// CHECK-LABEL: func.func @attention(
// CHECK-SAME: %arg0: tensor<1x4x1024x128xf16>, %arg1: tensor<1x1x1024x128xf16>, %arg2: tensor<1x1x1024x128xf16>) -> tensor<1x4x1024x128xf16>
// CHECK-NOT: stablehlo
// CHECK-NOT: linalg.batch_matmul
// CHECK-NOT: linalg.transpose
// CHECK-NOT: linalg.generic
// CHECK: %[[OUT:.*]] = memref.alloc() : memref<1x4x1024x128xf16>
