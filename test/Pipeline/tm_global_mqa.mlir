...
module attributes {transform.with_named_sequence} {
  ...
  func.func @attention(%arg0: tensor<1x4x1024x128xf16>, %arg1: tensor<1x1x1024x128xf16>, %arg2: tensor<1x1x1024x128xf16>) -> tensor<1x4x1x1024x128xf16> {
    ...
    %5 = stablehlo.transpose %2, dims = [0, 1, 2, 4, 3] : (tensor<1x4x1x1024x128xf16>) -> tensor<1x4x1x128x1024xf16>
    %6 = stablehlo.broadcast_in_dim %5, dims = [0, 1, 2, 3, 4] : (tensor<1x4x1x128x1024xf16>) -> tensor<1x4x1x128x1024xf16>
    %7 = stablehlo.dot_general %0, %6, batching_dims = [0, 1, 2] x [0, 1, 2], contracting_dims = [4] x [3] : (tensor<1x4x1x1024x128xf16>, tensor<1x4x1x128x1024xf16>) -> tensor<1x4x1x1024x1024xf32>
    %8 = stablehlo.convert %cst_1 : (tensor<1xf64>) -> tensor<1xf32>
    %9 = stablehlo.reshape %8 : (tensor<1xf32>) -> tensor<f32>
    %10 = stablehlo.broadcast_in_dim %9, dims = [] : (tensor<f32>) -> tensor<1x4x1x1024x1024xf32>
    %11 = stablehlo.multiply %7, %10 : tensor<1x4x1x1024x1024xf32>
    %12 = stablehlo.reduce(%11 init: %cst) applies stablehlo.maximum across dimensions = [4] : (tensor<1x4x1x1024x1024xf32>, tensor<f32>) -> tensor<1x4x1x1024xf32>
    %13 = stablehlo.reshape %12 : (tensor<1x4x1x1024xf32>) -> tensor<1x4x1x1024x1xf32>
    %14 = stablehlo.broadcast_in_dim %13, dims = [0, 1, 2, 3, 4] : (tensor<1x4x1x1024x1xf32>) -> tensor<1x4x1x1024x1024xf32>
    %15 = stablehlo.subtract %11, %14 : tensor<1x4x1x1024x1024xf32>
    %16 = stablehlo.exponential %15 : tensor<1x4x1x1024x1024xf32>
    %17 = stablehlo.reduce(%16 init: %cst_0) applies stablehlo.add across dimensions = [4] : (tensor<1x4x1x1024x1024xf32>, tensor<f32>) -> tensor<1x4x1x1024xf32>
    %18 = stablehlo.reshape %17 : (tensor<1x4x1x1024xf32>) -> tensor<1x4x1x1024x1xf32>
    %19 = stablehlo.broadcast_in_dim %18, dims = [0, 1, 2, 3, 4] : (tensor<1x4x1x1024x1xf32>) -> tensor<1x4x1x1024x1024xf32>
    %20 = stablehlo.divide %16, %19 : tensor<1x4x1x1024x1024xf32>
    %21 = stablehlo.convert %20 : (tensor<1x4x1x1024x1024xf32>) -> tensor<1x4x1x1024x1024xf16>
    %22 = stablehlo.broadcast_in_dim %4, dims = [0, 1, 2, 3, 4] : (tensor<1x4x1x1024x128xf16>) -> tensor<1x4x1x1024x128xf16>
    %23 = stablehlo.dot_general %21, %22, batching_dims = [0, 1, 2] x [0, 1, 2], contracting_dims = [4] x [3] : (tensor<1x4x1x1024x1024xf16>, tensor<1x4x1x1024x128xf16>) -> tensor<1x4x1x1024x128xf32>
    %24 = stablehlo.convert %23 : (tensor<1x4x1x1024x128xf32>) -> tensor<1x4x1x1024x128xf16>
    %25 = stablehlo.reshape %24 : (tensor<1x4x1x1024x128xf16>) -> tensor<1x4x1x1024x128xf16>
    return %25 : tensor<1x4x1x1024x128xf16>
  }
}
