...
module attributes {transform.with_named_sequence} {
  ...
  func.func @insert_slice(%init: tensor<2x4xf32>, %tiles: tensor<2x4xf32>,
...
// CHECK: %[[INIT:.*]] = tensor.insert_slice %arg0 into %arg2[0, 1, 0]
// CHECK: %[[RESULT:.*]] = scf.forall
// CHECK-SAME: shared_outs(%[[OUT:.*]] = %[[INIT]]) -> (tensor<2x3x4xf32>)
...
module attributes {transform.with_named_sequence} {
  ...
  func.func @expand_shape(%init: tensor<2x4xf32>, %tiles: tensor<2x4xf32>)
    ...
    %expanded = tensor.expand_shape %result [[0], [1, 2]] output_shape [2, 2, 2]
        : tensor<2x4xf32> into tensor<2x2x2xf32>
    return %expanded : tensor<2x2x2xf32>
  }
}

// CHECK-LABEL: func.func @expand_shape
// CHECK: %[[INIT:.*]] = tensor.expand_shape %arg0
// CHECK: %[[RESULT:.*]] = scf.forall
// CHECK-SAME: shared_outs(%[[OUT:.*]] = %[[INIT]]) -> (tensor<2x2x2xf32>)
