...
module {
  ...
  htile.kernel @decode_partial(%arg0: memref<4x16xf32>) attributes {program_bounds = array<i64: 4, 16>} {
    %pid0 = htile.program_id 0
    %pid1 = htile.program_id 1
    htile.return
  }
}

// CHECK: htile.launch_func @decode_partial(%{{.*}}) {grid = array<i64: 4, 16, 1>} : index
// CHECK: htile.kernel @decode_partial(%{{.*}} : memref<4x16xf32>) attributes {program_bounds = array<i64: 4, 16>} {
